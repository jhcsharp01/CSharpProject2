...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //따라서 PlayerController를 컴포넌트로 쓰고 있는 Circle의 Rigidbody2D 컴포넌트를 가져와 사용하는 개념
    }
    ...
    void Jump()
    {
        ...
        //Jump는 InputManager에서 Space 키로 작동합니다.
    ...
    void Move()
    {
        ...
        //AddForce는 방향과 힘 모드를 통해 힘을 가하는 문법
        //유니티에서 방향은 Vector2를 통해 2d의 x축과 y축의 좌표를 표현합니다.
        //                Vector3를 통해 3d의 x,y,z축의 좌표를 표현합니다.
        //힘 모드는 물체에 힘을 가하는 것에 대한 설정
        //2D 기준 Impulse , Force로 나뉘며 순간적인 힘이냐 지속적인 힘이냐로 갈립니다.

        //물체의 x 좌표 속력이 설정해둔 최대 스피드보다 빠르다면
